...
This directory contains **implementation-grade** action plans (work breakdowns) that translate ADRs
into PR-sized steps with explicit acceptance criteria.
...
- `Milestone-1.5-Proof-Hardening.md`
- `Milestone-2.0-MultiAsset-Foundation.md`
- `Milestone-2.1-MultiRoll-Framework.md`
- `Milestone-2.2-Keno-Module.md`
