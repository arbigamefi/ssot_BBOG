> **Historical handoff, not current operating instructions.** This page preserves earlier Milestone 4 evidence and retired v1.3 commands. Do not execute those commands against v1.5. Use the [current release facts](../release/STATUS-v1.5.zh-CN.md), [current workflow](../deploy/v15-release.md) and [2026-09-25 review](../audit/RepositoryReview-2026-09-25.zh-CN.md). Test gates described here are not a proof that all current code is correct.
