  ...
  if (isPrototypeVariant) {
    return (
      <div className={cn("space-y-4", className)}>
        <div className="relative overflow-hidden rounded-[2.35rem] border border-white/10 bg-[linear-gradient(180deg,rgba(10,13,24,0.98),rgba(4,7,13,0.98))] px-5 py-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] md:px-8">
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute left-1/2 top-[22%] h-[280px] w-[280px] -translate-x-1/2 rounded-full bg-amber-400/10 blur-[80px]" />
            <div className="absolute left-1/2 top-[58%] h-[360px] w-[600px] -translate-x-1/2 rounded-full bg-fuchsia-500/5 blur-[120px]" />
          </div>

          <div className="relative z-10 grid gap-6 xl:grid-cols-[280px_minmax(0,1fr)]">
            <div className="flex min-h-[360px] flex-col items-center justify-center gap-5 rounded-[1.9rem] border border-white/10 bg-white/[0.03] p-6 text-center">
              <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">
                Selected face
              </div>
              <div className="flex h-44 w-44 items-center justify-center rounded-full border border-white/10 bg-[radial-gradient(circle,rgba(250,204,21,0.4),rgba(82,38,10,0.82))] shadow-[0_0_0_14px_rgba(15,23,42,0.55)]">
                <div className="text-center">
                  <div className="text-[11px] font-semibold uppercase tracking-[0.16em] text-amber-100/75">
                    Live call
                  </div>
            ...
            <div className="space-y-4 rounded-[1.9rem] border border-white/10 bg-white/[0.03] p-5">
              <div className="flex items-center justify-between gap-4 rounded-[1.25rem] border border-white/10 bg-black/20 px-4 py-4">
                <div>
                  <div className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500">
                    Call the flip
                  </div>
                  <div className="mt-1 text-base font-semibold text-white">
                    {side === "heads" ? "Heads" : "Tails"} is active
                  </div>
                </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                >
                  ...
                  <div className="mt-4 text-sm leading-6 text-slate-400">
                    Simple binary call. Pick the face here, then size the ticket on the rail.
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="mt-4 text-sm leading-6 text-slate-400">
                    Same execution path, opposite face. Keep the surface binary and readable.
                  </div>
                </button>
              </div>
            </div>
        ...
        <div className="grid gap-5 lg:grid-cols-[220px_minmax(0,1fr)]">
          <div className="flex min-h-[280px] flex-col items-center justify-center gap-5 rounded-[1.75rem] border border-fuchsia-300/10 bg-[radial-gradient(circle_at_top,rgba(250,204,21,0.16),transparent_32%),linear-gradient(180deg,rgba(31,12,48,0.92),rgba(10,15,28,0.98))] px-6 py-6 text-center shadow-[0_24px_70px_rgba(120,53,15,0.18)]">
            ...
            <p className="max-w-[16rem] text-sm leading-6 text-slate-400">
              One face, one ticket, one reveal. Call the flip here, then size the stake on the
              right.
            </p>
          </div>
          ...
          <div className="space-y-4 rounded-[1.75rem] border border-fuchsia-300/10 bg-slate-950/35 p-5">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              >
                ...
                <div className="mt-4 text-sm leading-6 text-slate-400">
                  Cleanest call if you want the ticket to read like a simple yes/no slip.
                </div>
              </button>
              ...
              >
                ...
                <div className="mt-4 text-sm leading-6 text-slate-400">
                  Same execution path, different face. Pick the side you want the reveal to land on.
                </div>
              </button>
            </div>
