          ...
          <div className="flex flex-col gap-8">
              ...
              <div className="flex justify-between items-center mb-8 relative z-10">
                <div>
                  ...
                  <p className="text-sm text-emerald-500/80 font-mono tracking-tighter">
                    Historical growth driven by strict mathematical edge.
                  </p>
                </div>
                  ...
                  {["1W", "1M", "3M", "ALL"].map((tf, i) => (
                    <button
                      ...
                      className={cn(
                        ...
                        i === 1
                          ? "bg-emerald-500/20 text-emerald-400 shadow-[0_0_10px_rgba(16,185,129,0.2),inset_0_1px_2px_rgba(255,255,255,0.2)] border border-emerald-500/30"
            ...
            <div className="rounded-[2rem] border-2 border-orange-500/30 bg-[#0a0a0a] shadow-[0_0_30px_rgba(249,115,22,0.05),inset_0_2px_15px_rgba(249,115,22,0.05)] p-6 flex gap-6 items-start relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-orange-400 font-bold mb-2 flex items-center gap-2 drop-shadow-[0_0_5px_#fb923c]">
                  SSOT Risk Engine is Active{" "}
                  <span className="w-1.5 h-1.5 rounded-full bg-orange-400 animate-pulse" />
                </h3>
                <p className="text-sm text-white/50 leading-relaxed font-mono tracking-tighter">
                  This bank uses rigid upper-bound risk checks. Payouts for un-settled tickets are
                  strictly locked from the free capital pool. Withdrawals are instant but naturally
                  capped by un-finalized protocol liabilities.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-[2.5rem] border border-blue-500/20 bg-[#020202] shadow-[0_30px_60px_rgba(0,0,0,0.8),inset_0_2px_15px_rgba(255,255,255,0.02)] p-2 relative overflow-hidden h-full">
              ...
              <div className="bg-[#050505] rounded-[2.2rem] border border-white/5 h-full p-6 md:p-8 flex flex-col relative z-10 shadow-[inner_0_0_20px_rgba(0,0,0,1)]">
                ...
                <div className="flex mb-8 bg-[#020202] rounded-xl p-1 border border-white/5 shadow-[inset_0_2px_5px_rgba(0,0,0,1)]">
                  <button className="flex-1 py-3 text-sm font-bold text-emerald-400 bg-emerald-500/10 rounded-lg shadow-[inset_0_2px_5px_rgba(255,255,255,0.1)] border border-emerald-500/20">
                    Deposit USDC
                  </button>
                  <button className="flex-1 py-3 text-sm font-bold text-white/40 hover:text-white transition-colors rounded-lg border border-transparent">
                    Redeem
                  </button>
                </div>

                <p className="text-white/40 text-sm mb-6 leading-relaxed font-mono tracking-tighter">
                  Deposit USDC into the house bankroll to begin accruing real yield from global game
                  settlements.
                </p>
                ...
                <div className="bg-[#020202] border border-emerald-500/30 shadow-[inset_0_2px_15px_rgba(0,0,0,1)] rounded-2xl p-5 mb-6 focus-within:border-emerald-400 focus-within:shadow-[0_0_20px_rgba(16,185,129,0.2),inset_0_2px_15px_rgba(0,0,0,1)] transition-all group">
                  <div className="flex justify-between items-center mb-3">
                    <span className="text-[10px] font-bold uppercase tracking-widest text-emerald-500/60 group-focus-within:text-emerald-400">
                      Amount
                    </span>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    />
                    <button className="px-4 py-2 bg-emerald-500/10 hover:bg-emerald-500/20 rounded-xl text-xs font-extrabold text-emerald-400 transition-colors border border-emerald-500/30 shadow-[inset_0_2px_5px_rgba(255,255,255,0.1)]">
                      MAX
                    </button>
                  </div>
                </div>
                ...
                <div className="rounded-xl border border-white/5 bg-[#020202] p-5 flex flex-col gap-4 mb-8 shadow-[inset_0_2px_5px_rgba(0,0,0,0.5)]">
                  <div className="flex justify-between items-center text-sm border-b border-white/5 pb-2">
                    ...
                    <span className="text-emerald-400 font-extrabold drop-shadow-[0_0_5px_rgba(52,211,153,0.8)]">
                      ~24.50%
                    </span>
                  </div>
                  <div className="flex justify-between items-center text-sm border-b border-white/5 pb-2">
                ...
                <p className="text-center text-[10px] text-emerald-500/50 pt-5 font-mono uppercase tracking-widest font-bold">
