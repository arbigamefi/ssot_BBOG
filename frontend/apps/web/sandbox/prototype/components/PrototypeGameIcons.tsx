...
export const DiceMiniIcon = () => (
  <div
    className="relative w-32 h-32 flex items-center justify-center group-hover:scale-110 transition-transform duration-700"
    style={{ perspective: "800px" }}
  >
    <div
      className="w-20 h-20 relative animate-[spin_6s_linear_infinite]"
      style={{ transformStyle: "preserve-3d", transform: "rotateX(-20deg) rotateY(45deg)" }}
    >
      {/* Front Face */}
      <div
        className="absolute inset-0 bg-purple-600/90 border-2 border-purple-300 rounded-xl shadow-[inset_0_0_20px_rgba(168,85,247,0.8)] flex items-center justify-center backface-hidden"
        style={{ transform: "translateZ(40px)" }}
      >
        <span className="text-3xl font-mono font-bold text-white drop-shadow-[0_0_10px_white]">
          42
        </span>
      </div>
      {/* Back Face */}
      <div
        className="absolute inset-0 bg-purple-900/90 border-2 border-purple-500 rounded-xl flex items-center justify-center backface-hidden"
        style={{ transform: "rotateY(180deg) translateZ(40px)" }}
      />
      {/* Right Face */}
      <div
        className="absolute inset-0 bg-purple-700/90 border-2 border-purple-400 rounded-xl flex items-center justify-center flex-col gap-1 backface-hidden"
      ...
      {/* Left Face */}
      <div
        className="absolute inset-0 bg-purple-800/90 border-2 border-purple-500 rounded-xl flex items-center justify-center backface-hidden"
        style={{ transform: "rotateY(-90deg) translateZ(40px)" }}
      />
      {/* Top Face */}
      <div
        className="absolute inset-0 bg-purple-500/90 border-2 border-purple-300 rounded-xl flex items-center justify-center backface-hidden"
        style={{ transform: "rotateX(90deg) translateZ(40px)" }}
      />
      {/* Bottom Face */}
      <div
        className="absolute inset-0 bg-purple-950/90 border-2 border-purple-700 rounded-xl flex items-center justify-center backface-hidden"
        style={{ transform: "rotateX(-90deg) translateZ(40px)" }}
      />
    </div>
...
export const RouletteMiniIcon = () => (
  <div className="relative w-32 h-32 flex items-center justify-center group-hover:scale-110 transition-transform duration-700 shadow-[0_20px_40px_rgba(0,0,0,0.8)] rounded-full border-4 border-[#222]">
    ...
    <div
      className="w-[82%] h-[82%] rounded-full absolute group-hover:animate-[spin_2s_cubic-bezier(0.1,0.7,0.1,1)_infinite] overflow-hidden border border-[#B8860B]/50 flex items-center justify-center"
      style={{
        background: "repeating-conic-gradient(#b91c1c 0 9.72deg, #1a1a1a 9.72deg 19.45deg)"
      }}
    >
...
export const CoinTossMiniIcon = () => (
  ...
  >
    <div
      className="w-24 h-24 relative group-hover:animate-[spin_1.5s_linear_infinite]"
    ...
    >
      ...
      {Array.from({ length: 6 }).map((_, i) => (
        <div
          key={i}
          className="absolute inset-0 rounded-full border-[6px] border-[#B45309] pointer-events-none backface-hidden"
      ...
      {/* Front Face (Heads) */}
      <div
        className="absolute inset-0 rounded-full border-[6px] border-amber-300 bg-[radial-gradient(ellipse_at_top_right,#fbbf24,#b45309_70%)] flex flex-col items-center justify-center shadow-[inset_0_0_20px_rgba(120,53,15,0.8)] overflow-hidden backface-hidden"
      ...
      {/* Back Face (Tails) */}
      <div
        className="absolute inset-0 rounded-full border-[6px] border-indigo-300 bg-[radial-gradient(ellipse_at_top_right,#818cf8,#3730a3_70%)] flex flex-col items-center justify-center shadow-[inset_0_0_20px_rgba(49,46,129,0.8)] overflow-hidden backface-hidden"
      ...
      return (
        <div
          ...
          className={cn(
            ...
            isHit
              ? "bg-fuchsia-500 border-fuchsia-300 text-white shadow-[0_0_15px_rgba(217,70,239,0.8)] group-hover:animate-pulse"
