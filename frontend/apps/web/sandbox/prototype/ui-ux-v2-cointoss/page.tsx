      ...
      <div className="mb-6">
        ...
        <div className="flex bg-[#050505] p-1.5 rounded-2xl border border-white/10 relative shadow-inner">
          ...
          <button
            ...
            className={cn(
              "flex-1 py-4 rounded-xl font-bold uppercase tracking-wider text-sm relative z-10 transition-colors flex items-center justify-center gap-2",
              selectedTarget === "HEADS"
          ...
          >
            <SparklesIcon
              className={cn(
                "w-5 h-5",
                selectedTarget === "HEADS" ? "text-amber-900" : "opacity-50"
              )}
            />
            Heads
          </button>
          ...
          >
            <ShieldCheckIcon
              className={cn(
                "w-5 h-5",
                selectedTarget === "TAILS" ? "text-indigo-900" : "opacity-50"
              )}
            />
            Tails
          </button>
          ...
          <div className="flex items-center px-4 pt-2">
            <CurrencyDollarIcon
              className={cn(
                ...
                selectedTarget === "HEADS" ? "text-amber-500/50" : "text-indigo-500/50"
              )}
            />
            <input
              type="number"
        ...
        <div className="bg-[#050505] p-4 rounded-2xl border border-white/10 flex flex-col shadow-inner">
          ...
          <span
            className={cn(
              ...
              selectedTarget === "HEADS" ? "text-amber-400" : "text-indigo-400"
            )}
          >
            1.98x
          </span>
  ...
  const RightPane = (
    <>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center p-8 z-10 pointer-events-none">
        ...
        <div
          className={cn(
            "absolute bottom-[10%] w-[80%] max-w-[500px] h-[100px] rounded-[100%] border-[2px] transition-all duration-1000 blur-[2px]",
            selectedTarget === "HEADS"
              ? "border-amber-500/20 bg-amber-500/5 shadow-[0_0_100px_rgba(245,158,11,0.15)]"
              : "border-indigo-500/20 bg-indigo-500/5 shadow-[0_0_100px_rgba(99,102,241,0.15)]"
          )}
          style={{ transform: "translateY(120px) scaleY(0.4)" }}
        >
        ...
        >
          ...
          <div
            className={cn(
              "w-48 h-48 md:w-64 md:h-64 rounded-full relative shadow-[0_50px_100px_rgba(0,0,0,0.8)]",
              isTossing ? "coin-tossing" : "coin-rest"
            )}
          ...
          >
            ...
            {Array.from({ length: 12 }).map((_, i) => (
              <div
                ...
                style={{
                  ...
                  borderColor: isTossing
                    ? "#9CA3AF"
                    : resultTarget === "HEADS"
                      ? "#92400E"
                      : "#3730A3" // Metallic transition color
                }}
              />
            ))}
            ...
            <div
              className="absolute inset-0 rounded-full border-[10px] border-amber-300 bg-[radial-gradient(ellipse_at_top_right,#fbbf24,#b45309_70%)] flex flex-col items-center justify-center shadow-[inset_0_0_40px_rgba(120,53,15,0.8)] overflow-hidden backface-hidden"
            ...
            >
              ...
              <div className="w-full h-full absolute inset-0 flex items-center justify-center rotate-45 opacity-20">
                ...
                <div className="w-[1px] h-[120%] bg-white absolute" />
              </div>
              ...
              <div className="w-32 h-32 rounded-full border-[6px] border-amber-200/50 flex flex-col items-center justify-center shadow-[0_0_20px_rgba(251,191,36,0.6),inset_0_0_15px_rgba(120,53,15,0.8)] relative z-10 bg-amber-500/20 backdrop-blur-md">
                ...
                <span className="text-2xl font-extrabold text-amber-100 tracking-widest drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
                  HEADS
                </span>
              </div>
            </div>
            ...
            <div
              className="absolute inset-0 rounded-full border-[10px] border-indigo-300 bg-[radial-gradient(ellipse_at_top_right,#818cf8,#3730a3_70%)] flex flex-col items-center justify-center shadow-[inset_0_0_40px_rgba(49,46,129,0.8)] overflow-hidden backface-hidden"
            ...
            >
              ...
              <div className="w-32 h-32 rounded-full border-[6px] border-indigo-200/50 flex flex-col items-center justify-center shadow-[0_0_20px_rgba(129,140,248,0.6),inset_0_0_15px_rgba(49,46,129,0.8)] relative z-10 bg-indigo-500/20 backdrop-blur-md">
                ...
                <span className="text-2xl font-extrabold text-indigo-100 tracking-widest drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
                  TAILS
                </span>
              </div>
            </div>
      ...
      <div
        className={cn(
          "absolute bottom-12 left-1/2 -translate-x-1/2 transition-all duration-700 pointer-events-none flex flex-col items-center",
          isTossing ? "opacity-0 translate-y-4" : "opacity-100 translate-y-0"
        )}
      >
        <span className="text-[10px] text-white/30 tracking-[0.3em] uppercase mb-2">
          Awaiting Toss for Target
        </span>
        <div
          className={cn(
            "px-8 py-3 rounded-full border backdrop-blur-md font-extrabold tracking-widest text-lg transition-colors duration-500 shadow-[0_0_40px_rgba(0,0,0,0.5)]",
            selectedTarget === "HEADS"
              ...
              {isWin ? (
                <>
                  <span className="text-emerald-400 font-bold mb-2 flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" /> PREDICTION
                    CORRECT
                  </span>
                  <span className="text-4xl font-mono text-emerald-300 font-extrabold">
                    +{(betAmount * 1.98).toFixed(2)} <span className="text-lg">USDC</span>
                  </span>
                </>
              ) : (
                <>
                  <span className="text-red-500 font-bold mb-2 flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-red-500" /> PREDICTION INCORRECT
                  </span>
        ...
        <div className="grid grid-cols-[1fr_1.5fr_1.5fr_1fr_80px] items-center">
          ...
          <AuditTableCell>
            <div className="flex flex-col">
              <span
                className={cn(
                  "font-bold font-mono text-xs mb-1",
                  selectedTarget === "HEADS" ? "text-amber-400" : "text-indigo-400"
                )}
              >
                {selectedTarget}
          ...
          <AuditTableCell>
            <div className="flex items-center gap-2">
              <span
                className={cn(
                  "py-1.5 px-3 rounded-lg border font-mono text-[10px] uppercase font-bold animate-pulse",
                  selectedTarget === "HEADS"
