      ...
      <main className="relative z-10 max-w-[1440px] mx-auto px-6 py-12 md:py-16">
        ...
        <header className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-white/50 leading-relaxed">
              ...
              reserve bank. Connect wallet to enter.
            </p>
          </div>
          ...
          <div className="flex gap-6 rounded-2xl border-2 border-emerald-500/20 bg-[#020202] shadow-[0_0_30px_rgba(16,185,129,0.1),inset_0_2px_15px_rgba(16,185,129,0.05)] p-4 px-6 select-none relative overflow-hidden">
            ...
            <div className="flex flex-col relative z-10">
              <span className="text-[10px] text-emerald-500/80 uppercase tracking-widest font-bold mb-1">
                Live Players
              </span>
            ...
            <div className="flex flex-col relative z-10">
              <span className="text-[10px] text-amber-500/80 uppercase tracking-widest font-bold mb-1">
                Max Win (24h)
              </span>
              <span className="text-xl font-mono text-amber-400 drop-shadow-[0_0_5px_rgba(251,191,36,0.8)]">
                $12,400
              </span>
            </div>
          </div>
        ...
        <div className="mb-10 flex flex-col sm:flex-row items-center gap-4">
          ...
          <div className="flex-1 flex overflow-x-auto hide-scrollbar gap-2 w-full sm:w-auto p-1 bg-[#050505] rounded-[1.25rem] border border-white/5 shadow-[inset_0_2px_10px_rgba(0,0,0,0.6)]">
            <button className="px-6 py-3.5 rounded-xl bg-blue-500 text-black text-sm font-extrabold flex-shrink-0 transition-transform shadow-[0_0_20px_rgba(59,130,246,0.4),inset_0_2px_4px_rgba(255,255,255,0.4)]">
              All Modules
            </button>
            <button className="px-6 py-3.5 rounded-xl bg-transparent text-white/40 hover:text-blue-300 hover:bg-blue-500/10 text-sm font-bold flex-shrink-0 transition-all border border-transparent hover:border-blue-500/30">
              Table Games
            </button>
            <button className="px-6 py-3.5 rounded-xl bg-transparent text-white/40 hover:text-blue-300 hover:bg-blue-500/10 text-sm font-bold flex-shrink-0 transition-all border border-transparent hover:border-blue-500/30">
              Binary / Fast
          ...
          {games.map((game) => (
            ...
            >
              ...
              <div className="absolute top-5 left-5 right-5 flex justify-between items-start z-20 pointer-events-none">
                ...
                <div
                  className={cn(
                    "px-3 py-1.5 rounded-lg bg-[#020202]/90 border shadow-[inset_0_2px_5px_rgba(255,255,255,0.1)] backdrop-blur-md flex items-center gap-2",
                    `border-${game.color}-500/40`
                  )}
                >
                  <span
                    className={cn(
                      "w-2 h-2 rounded-full animate-pulse shadow-[0_0_8px_currentColor]",
                      `bg-${game.color}-500 text-${game.color}-500`
                    )}
                  />
              ...
              <div className="p-6 border-t border-white/10 bg-[#0a0a0a]/90 relative z-20 backdrop-blur-xl shadow-[inset_0_2px_15px_rgba(255,255,255,0.05)] pt-8">
                <h3
                  className={cn(
                    "text-2xl font-extrabold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-white",
                    `to-${game.color}-200`
                  )}
                >
                  {game.title}
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-white/40 text-sm">
                  Synchronized across all SSOT modules instantly.
                </p>
              </div>
            </div>
