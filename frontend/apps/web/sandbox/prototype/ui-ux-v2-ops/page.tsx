      ...
      <main className="mx-auto max-w-[1440px] px-6 py-12 md:py-16">
        <div className="mb-12 max-w-3xl">
          ...
          <p className="text-lg leading-relaxed text-white/50">
            A trust-facing control surface for indexer health, release identity, and
            room-operational proof. This route should feel institutional and precise, not like a
            player dashboard.
          </p>
        </div>
            ...
            <div className="mb-8 flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 max-w-xl text-sm leading-6 text-white/50">
                  This panel should give operators and LPs a clean answer to one question: what
                  exact release, chain, and contract surface is this frontend currently presenting?
                </p>
              </div>
              ...
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <div className="mt-2 text-sm leading-6 text-white/50">
                    Keep emergency controls separated from player surfaces. This block should stay
          ...
          <div className="flex flex-col gap-6">
            <GlassCard padding="lg">
              ...
              <div className="mt-6 rounded-full bg-white/10">
                <div
                  className="h-2 rounded-full bg-gradient-to-r from-cyan-400 via-emerald-400 to-emerald-300"
                  style={{ width: "82%" }}
                />
              </div>
            </GlassCard>
