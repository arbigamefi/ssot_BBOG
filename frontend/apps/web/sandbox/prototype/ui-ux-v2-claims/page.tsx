      ...
      <main className="mx-auto max-w-[1440px] px-6 py-12 md:py-16">
        <div className="mb-12 max-w-3xl">
          ...
          <p className="text-lg leading-relaxed text-white/50">
            A dedicated route for XP accrual, protocol fee claims, and holdback sync actions. This
            page should feel like a reward terminal, not a generic admin screen.
          </p>
        </div>
        ...
        <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-3">
          <div className="flex flex-col justify-center rounded-[2rem] border-2 border-amber-500/20 bg-gradient-to-br from-[#1a1005] to-[#050505] p-8 shadow-[inset_0_0_40px_rgba(245,158,11,0.05),0_10px_40px_rgba(0,0,0,0.5)] group relative overflow-hidden transition-colors hover:border-amber-500/40">
            ...
            <span className="mb-1 text-3xl font-mono font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white to-amber-200 drop-shadow-[0_0_15px_rgba(245,158,11,0.3)] md:text-4xl">
              18,420.00
            </span>
          ...
          <div className="flex flex-col justify-center rounded-[2rem] border border-white/5 bg-[#0a0a0a] p-8 shadow-[inset_0_0_40px_rgba(255,255,255,0.02),0_10px_40px_rgba(0,0,0,0.5)] group relative overflow-hidden transition-colors hover:border-blue-500/30">
            ...
            <span className="mb-2 text-[10px] font-bold uppercase tracking-widest text-white/40">
              Synced Holdback
            </span>
            ...
            <div className="mb-10 flex items-start justify-between gap-4 relative z-10">
              <div>
                <div className="text-[10px] font-bold uppercase tracking-widest text-amber-500/50 flex items-center gap-2">
                  <div className="h-2 w-2 rounded-sm bg-amber-500 animate-pulse" /> Primary
                  Extraction Action
                </div>
                <h2 className="mt-2 text-3xl font-bold drop-shadow-[0_0_15px_rgba(255,255,255,0.1)]">
                  Claim Accrued XP
                </h2>
                <p className="mt-2 max-w-xl text-sm leading-6 text-white/50">
                  Execute smart contract interaction to extract earned Experience Points from
                  protocol liabilities directly to your linked wallet.
                </p>
              </div>
            ...
            <div className="grid gap-10 md:grid-cols-[1fr_minmax(300px,0.8fr)] relative z-10 flex-1">
              ...
              <div className="flex flex-col gap-6 w-full">
                ...
                <div className="w-full h-[180px] rounded-2xl border border-white/5 bg-[#050505] shadow-inner mb-2 relative flex items-center justify-center overflow-hidden perspective-[800px]">
                  ...
                  {/* 3D Visual */}
                  <div
                    className="relative w-32 h-32 flex items-center justify-center animate-[spin_15s_linear_infinite]"
                    style={{ transformStyle: "preserve-3d" }}
                  >
                    <div
                      className="absolute inset-0 border-[4px] border-amber-500/30 rounded-full"
                      style={{ transform: "rotateX(75deg)" }}
                    />
                    <div
                      className="absolute inset-0 border-[4px] border-amber-400/20 rounded-full"
                    ...
                    <div
                      className="w-12 h-12 bg-gradient-to-br from-amber-300 to-amber-600 rounded-lg shadow-[0_0_30px_rgba(245,158,11,0.8)]"
                ...
                <div className="rounded-2xl border border-amber-500/20 bg-amber-500/[0.03] p-6 mt-auto">
                  <div className="flex justify-between items-center text-xs mb-3">
                    <span className="text-amber-500/50 font-bold uppercase tracking-wider">
                      Settlement Path
                    </span>
                    <span className="font-mono font-bold text-amber-400 drop-shadow-[0_0_5px_rgba(245,158,11,0.4)]">
                      Preflight → Wallet
                    </span>
                  </div>
                  <div className="text-[11px] text-white/30 leading-relaxed font-mono">
                    <span className="text-emerald-500 mr-2">✓</span> Validating Merkle Proof...
                    <br />
                    <span className="text-emerald-500 mr-2">✓</span> Confirming Bank Liability
                    state.
                    <br />
                    Claims instantly sweep un-minted XP from protocol reserves directly into your
                    active externally owned account.
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-6">
                <div className="rounded-[2rem] border border-white/5 bg-[#050505] p-6 flex-1 shadow-inner flex flex-col justify-center relative overflow-hidden">
                  ...
                  <div className="text-[10px] font-bold uppercase tracking-widest text-white/30 mb-6">
                    Extraction Dossier
                  </div>
                  <div className="space-y-4 text-sm font-mono">
                    ...
                    <div className="flex items-center justify-between pb-4 border-b border-white/5">
                      ...
                      <span className="font-bold text-amber-400 drop-shadow-[0_0_8px_rgba(245,158,11,0.5)]">
                        1,200.00 XP
                      </span>
                    </div>
                    <div className="flex items-center justify-between pb-4 border-b border-white/5">
          ...
          <div className="flex flex-col gap-6">
            <div className="rounded-[2rem] border border-blue-500/20 bg-[#0a0a0a] p-8 shadow-[inset_0_0_30px_rgba(59,130,246,0.02),0_10px_30px_rgba(0,0,0,0.5)] hover:border-blue-500/40 transition-colors group">
              <div className="flex items-start justify-between gap-4 mb-8">
                <div>
                  <div className="text-[10px] font-bold uppercase tracking-widest text-blue-400/50 mb-2">
                    Secondary System Action
                  </div>
                  <h3 className="text-2xl font-bold drop-shadow-[0_0_10px_rgba(255,255,255,0.1)]">
                    Sync Holdback
                  </h3>
            ...
            <div className="rounded-[2rem] border border-green-500/20 bg-[#0a0a0a] p-8 shadow-[inset_0_0_30px_rgba(34,197,94,0.02),0_10px_30px_rgba(0,0,0,0.5)] hover:border-green-500/40 transition-colors group flex-1 flex flex-col justify-between">
              <div className="flex items-start justify-between gap-4 mb-6">
                <div>
                  <div className="text-[10px] font-bold uppercase tracking-widest text-green-400/50 mb-2 mt-1 flex items-center gap-2 px-3 py-1 bg-green-500/10 rounded-full border border-green-500/20 max-w-max">
                    {" "}
                    <ShieldCheckIcon className="w-3 h-3" /> Governance Only
                  </div>
                  <h3 className="text-2xl font-bold drop-shadow-[0_0_10px_rgba(255,255,255,0.1)]">
                    Sweep Protocol Fees
                  </h3>
                  <p className="mt-2 text-xs leading-6 text-white/40 max-w-[250px]">
                    Root authority routine to capture global system margin and redirect to
                    governance vaults.
                  </p>
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-6">
                  ...
                  <span className="font-mono text-xl text-green-400 font-bold drop-shadow-[0_0_10px_rgba(34,197,94,0.3)]">
                    512.20 USDC
                  </span>
                </div>
                ...
                <div className="text-center mt-3 text-[10px] uppercase font-bold text-white/20 tracking-widest">
                  Requires Multisig Authority
                </div>
              </div>
            </div>
          </div>
