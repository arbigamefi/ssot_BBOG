      ...
      <main className="max-w-[1440px] mx-auto px-6 py-12 md:py-16 flex flex-col gap-12">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col gap-2">
              <div className="text-indigo-400 text-[10px] font-bold uppercase tracking-[0.2em] flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-indigo-500 animate-pulse" /> Encrypted
                Identity
              </div>
              <h1 className="text-4xl md:text-5xl font-mono font-extrabold tracking-tight text-white flex items-center gap-3 drop-shadow-[0_0_20px_rgba(255,255,255,0.1)]">
                0x12...34af
                <button className="text-xs px-2 py-1 rounded-md bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all font-sans text-white/50 hover:text-white shadow-[0_0_10px_rgba(255,255,255,0)] hover:shadow-[0_0_10px_rgba(255,255,255,0.1)]">
                  Copy
                </button>
              </h1>
              <div className="flex items-center gap-3 text-sm text-white/50 font-medium">
                ...
                <span className="text-emerald-400 hover:text-emerald-300 cursor-pointer flex items-center gap-1 transition-colors">
                  Arbiscan ↗
                </span>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="p-8 rounded-[2rem] border-2 border-indigo-500/20 bg-gradient-to-br from-indigo-950/20 to-[#050505] shadow-[inset_0_0_40px_rgba(99,102,241,0.05),0_10px_40px_rgba(0,0,0,0.5)] flex flex-col justify-center relative overflow-hidden group hover:border-indigo-500/40 transition-colors">
            ...
            <span className="text-4xl md:text-5xl font-mono font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white to-indigo-200 drop-shadow-[0_0_20px_rgba(99,102,241,0.3)] mb-2">
              $16,501.20
            </span>
            <span className="text-indigo-400 max-w-[200px] text-xs font-medium leading-relaxed">
              Cryptographically secured combined assets.
            </span>
          </div>
          ...
          <div className="p-8 rounded-[2rem] border border-white/5 bg-[#0a0a0a] shadow-[inset_0_0_40px_rgba(255,255,255,0.02),0_10px_40px_rgba(0,0,0,0.5)] flex flex-col justify-between col-span-1 lg:col-span-3 relative overflow-hidden group hover:border-white/10 transition-colors">
            ...
            <span className="text-white/40 text-[10px] font-bold uppercase tracking-widest mb-6">
              Asset Breakdown
            </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
              ...
              <div className="flex flex-col group/item">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-mono text-3xl font-bold text-white group-hover/item:text-shadow-[0_0_20px_rgba(255,255,255,0.5)] transition-all">
                    4,001.20
                  </span>
                </div>
              ...
              <div className="flex flex-col md:border-l border-white/5 md:pl-8 group/item">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-mono text-3xl font-bold text-blue-400 group-hover/item:text-shadow-[0_0_20px_rgba(59,130,246,0.5)] transition-all">
                    12,500.00
                  </span>
                </div>
                <span className="text-xs font-bold uppercase tracking-widest text-blue-400/50 mb-1">
                  hUSDC
                </span>
              ...
              <div className="flex flex-col md:border-l border-white/5 md:pl-8 group/item">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-mono text-3xl font-bold text-amber-500 group-hover/item:text-shadow-[0_0_20px_rgba(245,158,11,0.5)] transition-all">
                    24.50
                  </span>
                </div>
                <span className="text-xs font-bold uppercase tracking-widest text-amber-500/50 mb-1">
                  vAGF
                </span>
          ...
          <div className="flex justify-between items-end mb-8">
            <div>
              ...
              <p className="text-white/50 text-sm">
                Cryptographically verifiable on-chain actions mapped to your wallet.
              </p>
            </div>
          </div>
                ...
                <div className="grid grid-cols-[1fr_2fr_1fr_1fr_80px] items-center">
                  <AuditTableCell>
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-xs font-mono text-white/30 hover:text-white transition-colors cursor-pointer">
                        {tx.hash}
                      </span>
                    </div>
                  </AuditTableCell>
                  ...
                  <AuditTableCell>
                    <span
                      className={cn(
                        ...
                        tx.amount.startsWith("+") ? "text-green-400" : "text-white/60"
                      )}
                    >
                      {tx.amount}
                    </span>
                  ...
                  <AuditTableCell>
                    <span className="py-1 px-3 rounded-md bg-green-500/10 border border-green-500/20 text-green-400 font-mono text-[10px] uppercase font-bold tracking-widest">
                      {tx.status}
                    </span>
                  </AuditTableCell>
