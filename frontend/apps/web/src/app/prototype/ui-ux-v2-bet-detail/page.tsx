        ...
        <div className="relative mx-auto rounded-[2.5rem] border-2 border-green-500/20 bg-gradient-to-b from-[#0a0505] to-[#020502] p-10 shadow-[inset_0_0_60px_rgba(34,197,94,0.05),0_20px_60px_rgba(0,0,0,0.8)] overflow-hidden">
           ...
           <div className="flex flex-col items-center justify-center border-b border-white/10 pb-10 mb-10 relative z-10">
              <div className="flex items-center gap-3 mb-6">
                 ...
                 <span className="text-green-500/70 text-[10px] font-bold font-mono uppercase tracking-[0.3em]">Network Verified</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-black mb-3 text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.2)] tracking-tight">Precision Dice</h1>
              <span className="text-white/40 font-mono text-sm tracking-widest bg-[#050505] border border-white/10 px-4 py-1.5 rounded-lg shadow-inner">TICKET_ID: #209384</span>
           </div>
           ...
           <div className="grid grid-cols-2 gap-6 mb-10 relative z-10">
              <div className="bg-[#050505] p-6 rounded-[2rem] border border-white/5 shadow-inner flex flex-col justify-center relative overflow-hidden group">
                 ...
                 <span className="text-3xl font-mono font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.1)]">50.00 <span className="text-lg text-white/50">USDC</span></span>
              </div>
              <div className="bg-[#020502] p-6 rounded-[2rem] border-2 border-green-500/20 shadow-[inset_0_0_20px_rgba(34,197,94,0.05)] flex flex-col justify-center relative overflow-hidden group">
                 ...
                 <span className="text-green-500/60 text-[10px] font-bold uppercase tracking-widest mb-2">Gross Settlement</span>
                 <span className="text-3xl font-mono font-bold text-green-400 drop-shadow-[0_0_15px_rgba(34,197,94,0.4)]">+98.50 <span className="text-lg text-green-500/50">USDC</span></span>
              </div>
           </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10 border border-white/5 bg-[#080808] p-8 rounded-[2rem]">
              ...
              <div className="flex flex-col gap-4">
                 ...
                 <div className="flex flex-col font-mono text-sm gap-1">
                    <div className="flex justify-between py-3 border-b border-white/5 bg-white/[0.01] px-3 rounded-t-xl hover:bg-white/[0.03] transition-colors">
                      <span className="text-white/40 uppercase text-[10px] tracking-widest mt-0.5">Condition</span>
                    ...
                    <div className="flex justify-between py-3 border-b border-white/5 bg-white/[0.01] px-3 hover:bg-white/[0.03] transition-colors">
                      <span className="text-white/40 uppercase text-[10px] tracking-widest mt-0.5">Target Volatility</span>
                    ...
                    <div className="flex justify-between py-3 bg-white/[0.01] px-3 rounded-b-xl hover:bg-white/[0.03] transition-colors">
                      <span className="text-white/40 uppercase text-[10px] tracking-widest mt-0.5">Base Multiplier</span>
              ...
              <div className="flex flex-col gap-4">
                 <h3 className="text-[10px] font-bold text-green-400/60 uppercase tracking-[0.2em] mb-2 flex items-center gap-2">
                    <div className="w-1 h-1 bg-green-500 rounded-full shadow-[0_0_5px_rgba(34,197,94,1)]" /> Provable Truth
                 </h3>
                 <div className="flex flex-col font-mono text-sm gap-1">
                    <div className="flex justify-between py-3 border-b border-white/5 bg-green-500/[0.02] px-3 rounded-t-xl border-l-[3px] border-l-green-500/50">
                      <span className="text-green-500/50 uppercase text-[10px] tracking-widest mt-0.5">Final Generation</span>
                      <span className="text-green-400 font-bold drop-shadow-[0_0_5px_rgba(34,197,94,0.3)]">45.12</span>
                    </div>
                    <div className="flex justify-between py-3 border-b border-white/5 bg-white/[0.01] px-3 hover:bg-white/[0.03] transition-colors">
                      <span className="text-white/40 uppercase text-[10px] tracking-widest mt-0.5">Actor Auth</span>
                      <span className="text-blue-400 hover:text-blue-300 transition-colors cursor-pointer truncate max-w-[120px]">0x12...34af</span>
                    </div>
                    <div className="flex justify-between py-3 border-b border-white/5 bg-white/[0.01] px-3 hover:bg-white/[0.03] transition-colors">
                      <span className="text-white/40 uppercase text-[10px] tracking-widest mt-0.5">Block Anchor</span>
                      <span className="text-white">182303800</span>
                    </div>
                    <div className="flex justify-between py-3 bg-white/[0.01] px-3 rounded-b-xl hover:bg-white/[0.03] transition-colors">
                      <span className="text-white/40 uppercase text-[10px] tracking-widest mt-0.5">State Tx</span>
                      <span className="text-blue-400 hover:text-blue-300 transition-colors cursor-pointer truncate max-w-[120px]">0xebd9...2a1f</span>
                    </div>
                 </div>
              </div>
