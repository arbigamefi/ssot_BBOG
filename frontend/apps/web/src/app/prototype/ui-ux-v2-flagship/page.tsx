    ...
    <div className="min-h-screen bg-[#050505] font-sans text-white overflow-x-hidden selection:bg-blue-500/30">
      ...
      <section className="border-y border-white/5 bg-[#0a0a0a] overflow-hidden">
        <div className="max-w-[1440px] mx-auto px-6 py-8 flex flex-wrap items-center justify-center gap-12 md:gap-24">
          <div className="flex flex-col items-center md:items-start group cursor-default">
            ...
            <span className="text-3xl font-mono font-bold text-white group-hover:text-emerald-400 transition-colors">$2,450,112</span>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start group cursor-default">
            ...
            <span className="text-3xl font-mono font-bold text-white group-hover:text-blue-400 transition-colors">$18,104,890</span>
          </div>
          <div className="hidden md:block w-px h-12 bg-white/10" />
          <div className="flex flex-col items-center md:items-start group cursor-default">
            ...
            <span className="text-3xl font-mono font-bold text-white group-hover:text-purple-400 transition-colors">412 Organics</span>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#0a0a0a] py-24 border-y border-white/5">
         <div className="max-w-[1440px] mx-auto px-6">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
               ...
               <Link href="/prototype/ui-ux-v2-directory" className="text-white/50 hover:text-white font-bold transition-colors flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
               {/* Dice Card */}
               <Link href="/prototype/ui-ux-v2-dice" className="group relative rounded-3xl border border-white/10 bg-[#050505] overflow-hidden transition-all hover:border-purple-500/50 hover:shadow-[0_0_40px_rgba(168,85,247,0.15)] flex flex-col min-h-[320px]">
               ...
               {/* Roulette Card */}
               <Link href="/prototype/ui-ux-v2-roulette" className="group relative rounded-3xl border border-white/10 bg-[#050505] overflow-hidden transition-all hover:border-emerald-500/50 hover:shadow-[0_0_40px_rgba(16,185,129,0.15)] flex flex-col min-h-[320px]">
               ...
               {/* Coin Toss Card */}
               <Link href="/prototype/ui-ux-v2-cointoss" className="group relative rounded-3xl border border-white/10 bg-[#050505] overflow-hidden transition-all hover:border-amber-500/50 hover:shadow-[0_0_40px_rgba(245,158,11,0.15)] flex flex-col min-h-[320px]">
               ...
               {/* Keno Card */}
               <Link href="/prototype/ui-ux-v2-keno" className="group relative rounded-3xl border border-white/10 bg-[#050505] overflow-hidden transition-all hover:border-fuchsia-500/50 hover:shadow-[0_0_40px_rgba(217,70,239,0.15)] flex flex-col min-h-[320px]">
         ...
         <div className="max-w-[1440px] mx-auto px-6 grid grid-cols-1 xl:grid-cols-2 gap-16 lg:gap-24 relative z-10">
            ...
            <div className="flex flex-col justify-center">
               ...
               <div className="p-8 rounded-[2rem] border-2 border-emerald-500/30 bg-[#050505] shadow-[0_0_50px_rgba(16,185,129,0.15),inset_0_2px_20px_rgba(16,185,129,0.05)] relative overflow-hidden group">
                  ...
                  <div className="text-emerald-400/80 font-bold uppercase text-xs tracking-widest mb-4 flex flex-col gap-1 relative z-10 p-3 bg-emerald-900/20 border border-emerald-500/30 rounded-xl w-fit drop-shadow-[0_0_5px_rgba(16,185,129,0.5)]">
                     ...
                     <span className="text-[10px] text-emerald-300/80 font-mono font-normal">0x8B32df...f10A49</span>
                  </div>
            ...
            <div className="flex flex-col">
               <div className="flex items-center justify-between mb-8">
                  ...
                  <Link href="/prototype/ui-ux-v2-bets" className="text-sm font-bold text-white/40 hover:text-white transition-colors">
                     View Ledger →
                  </Link>
               </div>
         ...
         <div className="max-w-[1440px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-[1fr_1fr] items-center gap-16 lg:gap-24">
            ...
            <div className="order-1 lg:order-2">
               ...
               <div className="flex flex-col gap-4">
                  <Link href="/prototype/ui-ux-v2-ops" className="p-5 rounded-2xl border border-white/5 bg-white/[0.02] flex items-center justify-between hover:bg-white/[0.05] transition-colors group">
      ...
      <footer className="border-t border-white/10 bg-[#050505] py-12 text-center text-white/40 text-sm">
         <div className="flex items-center justify-center gap-4 mb-4">
           ...
           <Link href="/prototype/ui-ux-v2-liquidity" className="hover:text-white transition-colors">Isolated Bank</Link>
           <span className="w-1 h-1 bg-white/20 rounded-full" />
           <Link href="/prototype/ui-ux-v2-ops" className="hover:text-white transition-colors">Ops Proof</Link>
         </div>
