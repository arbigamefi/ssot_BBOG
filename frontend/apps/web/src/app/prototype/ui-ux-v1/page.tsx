...
function RoomCard({
  ...
  return (
    <div className="rounded-[1.6rem] border border-white/10 bg-[#081126] p-3">
      <div className={`rounded-[1.2rem] border border-white/10 bg-gradient-to-br ${accent} from-0% p-4`}>
      ...
      <div className="space-y-4 px-2 pb-2 pt-4">
        ...
        <div className="flex items-center justify-between border-t border-white/8 pt-4">
          ...
          <div className="rounded-full bg-white px-4 py-2 text-sm font-semibold text-slate-950">Enter room</div>
        </div>
      </div>
    </div>
  );
      ...
      <div className="border-b border-white/8 px-10 py-5">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="rounded-full bg-white px-5 py-2 text-sm font-semibold text-slate-950">Start Playing</div>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-7">
            ...
            <div className="space-y-5">
              ...
              <p className="max-w-2xl text-lg leading-8 text-slate-300">
                ArbiGameFi turns wallet-native gaming into a cleaner room experience. Choose the table,
                build the slip, and follow settlement without dropping into protocol clutter.
              </p>
            </div>

            <div className="flex items-center gap-3">
              <div className="rounded-full bg-white px-6 py-3 text-sm font-semibold text-slate-950">Start Playing</div>
            ...
            <div className="rounded-[1.6rem] border border-white/10 bg-white/[0.04] p-4">
              <div className="grid grid-cols-4 gap-3">
                {[
                  ...
                  <div key={label} className="rounded-[1.1rem] border border-white/8 bg-[#071024] px-4 py-4">
          ...
          <div className="rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(10,17,38,0.98),rgba(12,11,30,0.98))] p-5">
            ...
            <div className="mt-5 rounded-[1.6rem] border border-white/10 bg-[radial-gradient(circle_at_top,rgba(201,59,99,0.18),transparent_34%),linear-gradient(180deg,rgba(36,11,33,0.95),rgba(8,12,27,0.98))] p-5">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-400">Featured room</div>
                  <div className="mt-2 text-4xl font-black text-white">Roulette</div>
                  <p className="mt-3 text-sm leading-6 text-slate-300">
                    A premium European table with a compact slip, clearer ticket review, and a stronger board-first layout.
                  </p>
                </div>
              ...
              <div className="mt-6 space-y-3">
                {[
                  ...
                  ["Follow settlement", "Stay with the room while activity and proof remain readable."],
                ].map(([title, body], index) => (
                  <div key={title} className="flex items-start gap-4 rounded-[1.2rem] border border-white/8 bg-black/20 px-4 py-3">
        ...
        <div className="mt-10 grid grid-cols-[1.4fr_1fr] gap-6">
          ...
          <div className="space-y-5">
            <div className="rounded-[1.8rem] border border-white/10 bg-white/[0.03] p-5">
              ...
              <div className="mt-4 space-y-3">
                {["Choose a room", "Set your ticket", "Settle on-chain"].map((step, index) => (
                  <div key={step} className="flex items-center gap-4 rounded-[1.1rem] border border-white/8 bg-[#071024] px-4 py-4">
            ...
            <div className="rounded-[1.8rem] border border-white/10 bg-[linear-gradient(135deg,rgba(11,19,43,0.94),rgba(37,11,41,0.92))] p-5">
              ...
              <div className="mt-2 text-3xl font-black text-white">Start in the flagship rooms.</div>
              <div className="mt-2 text-sm leading-6 text-slate-300">Lead with Roulette, Dice, and Coin Toss, then open deeper audit routes only when the user asks for them.</div>
              <div className="mt-5 rounded-full bg-white px-5 py-3 text-center text-sm font-semibold text-slate-950">Start Playing</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="mt-6 grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
          <div className="space-y-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-cyan-300">Game directory</div>
                <div className="mt-2 text-6xl font-black tracking-[-0.06em] text-white">Choose the room, then enter the table.</div>
              </div>
            </div>
            <p className="max-w-3xl text-lg leading-8 text-slate-300">
              The directory is built for fast room selection. Featured tables lead, categories help decision-making, and every card answers what kind of play it offers.
            </p>
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <div key={label} className="rounded-[1.2rem] border border-white/10 bg-white/[0.04] px-4 py-4">
                  <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">{label}</div>
                  <div className="mt-2 text-2xl font-black text-white">{value}</div>
                </div>
              ))}
          ...
          <div className="rounded-[1.8rem] border border-white/10 bg-[linear-gradient(135deg,rgba(57,14,33,0.95),rgba(7,12,24,0.98))] p-5">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-300">
              The hero room for the brand: a standard European table, a compact slip, and the cleanest flagship presentation.
            </p>
            <div className="mt-6 space-y-3">
              {[
                "Classic table action",
                "Compact ticket review",
                "Lower-fold proof only",
              ].map((item) => (
                <div key={item} className="rounded-[1rem] border border-white/8 bg-black/20 px-4 py-3 text-sm font-semibold text-white">
                  {item}
                </div>
              ))}
            </div>
            <div className="mt-6 rounded-full bg-white px-5 py-3 text-center text-sm font-semibold text-slate-950">Enter roulette</div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-6 grid gap-5 xl:grid-cols-[340px_minmax(0,1fr)]">
        <div className="rounded-[2rem] border border-fuchsia-400/20 bg-[linear-gradient(180deg,rgba(34,12,42,0.98),rgba(10,15,29,0.98))] p-5">
          ...
          <div className="mt-4 rounded-[1.4rem] border border-white/10 bg-black/20 p-4">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">Rounds</div>
          ...
          <div className="mt-4 rounded-[1.4rem] border border-white/10 bg-black/20 p-4">
            ...
            <div className="mt-3 space-y-2 text-sm text-slate-300">
              ...
              <div className="flex items-center justify-between"><span>Wallet</span><span className="font-semibold text-white">Connected</span></div>
            </div>
            <div className="mt-3 text-xs leading-6 text-slate-500">Review quote, fee, and approvals in the trace only when the ticket is ready.</div>
          </div>

          <div className="mt-5 rounded-full bg-white px-5 py-3 text-center text-sm font-semibold text-slate-950">Place ticket</div>
        </div>
        ...
        <div className="rounded-[2rem] border border-fuchsia-400/20 bg-[radial-gradient(circle_at_top,rgba(201,59,99,0.16),transparent_24%),linear-gradient(180deg,rgba(42,13,42,0.98),rgba(7,12,24,0.98))] p-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <div className="mt-4 text-sm text-slate-300">Pick the board first. Dozens, columns, and outside bets stay attached to the table instead of floating as separate cards.</div>
            </div>
    ...
    <div className="min-h-[1120px] bg-[linear-gradient(180deg,#050816_0%,#03060f_100%)] px-5 py-6">
      <div className="rounded-[1.6rem] border border-white/10 bg-[linear-gradient(180deg,rgba(9,14,29,0.98),rgba(8,11,22,0.98))] p-4">
        ...
        <div className="mt-4 rounded-[1.3rem] border border-white/10 bg-white/[0.04] px-4 py-4">
          ...
          <div className="mt-2 text-sm leading-6 text-slate-400">Board first on mobile. Slip immediately after.</div>
        </div>
        ...
        <div className="mt-4 rounded-[1.6rem] border border-white/10 bg-[linear-gradient(180deg,rgba(34,12,42,0.98),rgba(10,15,29,0.98))] p-4">
          ...
          <div className="mt-4 rounded-full bg-white px-5 py-3 text-center text-sm font-semibold text-slate-950">Place ticket</div>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div>
        ...
        <div className="text-[10px] font-semibold uppercase tracking-[0.2em] text-slate-500">Premium table rooms</div>
      </div>
    </div>
  );
}
        ...
        <div className="rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(10,17,38,0.92),rgba(6,10,24,0.95))] p-6">
          <div className="flex flex-wrap items-start justify-between gap-6">
            <div className="space-y-3">
              ...
              <h1 className="text-4xl font-black tracking-[-0.05em] text-white">ArbiGameFi UI/UX Prototype v1</h1>
              <p className="max-w-3xl text-base leading-7 text-slate-300">
                A dedicated prototype board for Figma capture. These are not production routes. They are screen boards for acquisition, room selection, and flagship gameplay.
              </p>
            </div>
