...
describe("ReferralPageClient", () => {
  ...
  it("frames referral as a registry and transaction console", () => {
    renderWithQueryClient(<ReferralPageClient />);

    expect(screen.getByRole("heading", { name: /Affiliate referrals/i })).toBeDefined();
    expect(screen.getByText("Referral control plane")).toBeDefined();
    expect(screen.getByText("Referral settlement model")).toBeDefined();
    expect(screen.getByText("Referral transaction console")).toBeDefined();
    expect(screen.getByText("Connect a wallet to generate and bind referral state.")).toBeDefined();
    expect(screen.getByText("Session referral activity")).toBeDefined();
  });
});
