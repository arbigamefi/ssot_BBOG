...
vi.mock("next-intl", () => ({
  useTranslations: () => (key: string) =>
    ({
      ...
      "casino.room.stage.plinko.waitingVrf": "Waiting for draw...",
      ...
      "casino.room.stage.baccarat.dealing": "Waiting for draw...",
      ...
      "casino.room.stage.sicBo.rolling": "Waiting for draw...",
