...
export function ImmersiveGameLayout({
  ...
  return (
    <div
      className={cn("min-h-[calc(100vh-80px)] text-white font-sans overflow-x-hidden", t.selection)}
    >
      {/* Extreme Deep Ambient Glow */}
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[100%] h-[100%] bg-[url('/textures/noise.svg')] opacity-20 pointer-events-none z-0 mix-blend-overlay" />
      <div
        className={cn(
