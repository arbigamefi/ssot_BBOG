...
contract GenerateGoldenVectorsV14 is Script {
    ...
    string internal constant OUT_LATEST = "deployments/golden-vectors-latest-v14.json";
    ...
    function run() external {
        ...
        string memory json = string.concat(
            ...
            ",",
            "\"notes\":\"Vectors are for v1.4 IGameHub bytes-encoding correctness tests only. They are not intended as production defaults.\",",
            "\"vectors\":",
            vectors,
            "}\n"
        );
