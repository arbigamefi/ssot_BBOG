...
/// @notice Verifies a v1.4 release digest + signature against a router/pool snapshot.
contract VerifyReleaseV14 is Script {
    ...
    function run() external view {
        ...
        console2.log("OK v1.4 release artifact verified");
