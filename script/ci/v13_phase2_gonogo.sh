...
FOOTBALL_CANARY_DOC="docs/deploy/worldcup-football-mvp-canary-2026.md"
PROVIDER_POLICY_DOC="docs/ops/sportsbook-provider-evidence-policy.md"
THE_ODDS_PROVIDER_DOC="docs/ops/sportsbook-provider-the-odds-api.md"
...
ROLE_CUSTODY_POLICY_DOC="docs/ops/sportsbook-key-custody-roles.md"
ROLE_CUSTODY_TEMPLATE="docs/ops/templates/sportsbook-role-custody.example.json"
...
OPS_COVERAGE_POLICY_DOC="docs/ops/sportsbook-ops-coverage.md"
OPS_COVERAGE_TEMPLATE="docs/ops/templates/sportsbook-ops-coverage.example.json"
...
need_file "$FOOTBALL_CANARY_DOC"
need_file "$PROVIDER_POLICY_DOC"
need_file "$THE_ODDS_PROVIDER_DOC"
need_file "$RULEBOOK_TEMPLATE"
need_file "$RESULT_EVIDENCE_TEMPLATE"
need_file "$ROLE_CUSTODY_POLICY_DOC"
need_file "$ROLE_CUSTODY_TEMPLATE"
need_file "$BANKROLL_POLICY_DOC"
need_file "$BANKROLL_CAPS_TEMPLATE"
need_file "$OPS_COVERAGE_POLICY_DOC"
need_file "$OPS_COVERAGE_TEMPLATE"
...
need_text "$PACKET" "$FOOTBALL_CANARY_DOC"
need_text "$PACKET" "$PROVIDER_POLICY_DOC"
need_text "$PACKET" "$THE_ODDS_PROVIDER_DOC"
need_text "$PACKET" "$RULEBOOK_TEMPLATE"
need_text "$PACKET" "$RESULT_EVIDENCE_TEMPLATE"
need_text "$PACKET" "$ROLE_CUSTODY_POLICY_DOC"
need_text "$PACKET" "$ROLE_CUSTODY_TEMPLATE"
need_text "$PACKET" "$BANKROLL_POLICY_DOC"
need_text "$PACKET" "$BANKROLL_CAPS_TEMPLATE"
need_text "$PACKET" "$OPS_COVERAGE_POLICY_DOC"
need_text "$PACKET" "$OPS_COVERAGE_TEMPLATE"
...
need_text "$CONTROLS_DOC" "sportsbook-key-custody-roles.md"
need_text "$CONTROLS_DOC" "sportsbook-bankroll-risk-caps.md"
need_text "$CONTROLS_DOC" "sportsbook-ops-coverage.md"
need_text "$READINESS_DOC" "make sports-phase2-gonogo-v13"
need_text "$READINESS_DOC" "make sports-role-custody-check-v13"
need_text "$READINESS_DOC" "make sports-bankroll-caps-check-v13"
need_text "$READINESS_DOC" "make sports-ops-coverage-check-v13"
need_text "$READINESS_DOC" "$PROVIDER_POLICY_DOC"
need_text "$READINESS_DOC" "$THE_ODDS_PROVIDER_DOC"
need_text "$READINESS_DOC" "$ROLE_CUSTODY_POLICY_DOC"
need_text "$READINESS_DOC" "$BANKROLL_POLICY_DOC"
need_text "$READINESS_DOC" "$OPS_COVERAGE_POLICY_DOC"
need_text "$READINESS_DOC" "$FOOTBALL_CANARY_DOC"
need_text "$FOOTBALL_CANARY_DOC" "football 1X2 MVP product loop"
need_text "$FOOTBALL_CANARY_DOC" "getMarket(4).state = 7"
need_text "$FOOTBALL_CANARY_DOC" 'Sports Bank `totalReserved() = 0`'
...
need_text "$PROVIDER_POLICY_DOC" "sports_provider_evidence.py"
need_text "$PROVIDER_POLICY_DOC" "sports_provider_odds.py"
need_text "$PROVIDER_POLICY_DOC" "sportsbook.provider-evidence-approval.v1"
need_text "$PROVIDER_POLICY_DOC" "make sports-provider-policy-check-v13"
need_text "$THE_ODDS_PROVIDER_DOC" "make sports-provider-evidence-v13"
need_text "$THE_ODDS_PROVIDER_DOC" "make sports-provider-odds-v13"
need_text "$THE_ODDS_PROVIDER_DOC" "make sports-provider-e2e-v13"
need_text "$THE_ODDS_PROVIDER_DOC" "FOOTBALL_HOME_ODDS_WAD"
need_text "$THE_ODDS_PROVIDER_DOC" "FOOTBALL_RESULT_OBSERVED_AT"
need_text "$THE_ODDS_PROVIDER_DOC" "The Odds API"
need_text "$ROLE_CUSTODY_POLICY_DOC" "odds signer"
need_text "$ROLE_CUSTODY_POLICY_DOC" "result reporter"
need_text "$ROLE_CUSTODY_POLICY_DOC" "result challenger"
need_text "$ROLE_CUSTODY_POLICY_DOC" "result arbitrator"
need_text "$ROLE_CUSTODY_POLICY_DOC" "REQUIRE_APPROVED=1"
...
need_text "$OPS_COVERAGE_POLICY_DOC" "G1 odds reject spikes"
need_text "$OPS_COVERAGE_POLICY_DOC" "finalizeResult"
need_text "$OPS_COVERAGE_POLICY_DOC" "settleTickets"
need_text "$OPS_COVERAGE_POLICY_DOC" "refundTickets"
need_text "$OPS_COVERAGE_POLICY_DOC" "voidTickets"
...
echo "  footballCanary: $FOOTBALL_CANARY_DOC"
echo "  providerPolicy: $PROVIDER_POLICY_DOC"
echo "  theOddsProvider: $THE_ODDS_PROVIDER_DOC"
echo "  roleCustodyPolicy: $ROLE_CUSTODY_POLICY_DOC"
echo "  bankrollPolicy: $BANKROLL_POLICY_DOC"
echo "  opsCoveragePolicy: $OPS_COVERAGE_POLICY_DOC"
