...
# Runs the v1.3 Sports canary script.
#
# Usage:
#   bash script/ci/v13_sports_canary.sh [env-file]
#
...
args=(script/ops/SportsCanaryV13.s.sol:SportsCanaryV13 --rpc-url "$RPC_URL" -vvv)
